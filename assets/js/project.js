...
const projects = [
  {
    ...
    description: "JAVA | Maven | git | Docker | Selenium Grid | Selenoid | TestNG",
    tagimg: "https://github.com/Amit-Malbari/AmazonFrameworkFinal",
    Previewlink: "",
    Githublink: "https://github.com/Amit-Malbari/AmazonFrameworkFinal",
  },
  {
    ...
    Previewlink: "",
    Githublink: "https://github.com/Amit-Malbari/LocationAPI",
  },
];
    ...
    output += `       
        <div class="column skill-card card" style="margin: 15px"data-aos="zoom-in-up" data-aos-easing="linear" data-aos-delay="300" data-aos-duration="600" >
          <div class="wrapper" style="background: url(${cardImage}) center / cover no-repeat;">
            ...
            <ul class="menu-content">${description}<br>
				   <li></li>
